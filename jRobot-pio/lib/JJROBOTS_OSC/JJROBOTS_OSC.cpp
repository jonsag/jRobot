/*
  ...
  IMPORTANT: This library rewrite the original Arduino Serial1 code (Serial interrupts) so you could
  ...
  This library is free software; you can redistribute it and/or
    ...
    OSC Messages read:  OSC: /page/command parameters
             FADDER (1,2,3,4)  Ex: /1/fader1   f,  XXXX  => length:20, Param:  float (0.0-1.0)
...
// We describe the ISR for USART1
